    ...
    >
      <div class="w-50 relative flex items-center">
        <div class="w-20 relative flex items-center">
          <input type="checkbox" name="" id="" v-model="item.focused" @change="$store.commit('addSingleFocus', item.id)" />
          <div
        ...
        <div class="w-40 flex flex-col items-start">
          <p class="namep mb-1 py-1">{{ item.name }}</p>
        ...
        <div class="w-40 flex flex-col items-start">
          ...
          <p class="loginp">Last login: 14/APR/2020</p>
        </div>
      </div>
      <div class="w-50 relative flex items-center">
        <div class="w-50 flex flex-col items-start">
          ...
          <p v-if="item.paid" class="payment">Paid on 15/APR/2020</p>
